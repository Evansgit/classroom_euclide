...
import '../../Screen/FullApps/Vpn/desktop/Screens/VpnSelectVpnDesktop.dart';
import '../../Screen/FullApps/Vpn/desktop/Screens/VpnSubscriptionDetailDesktop.dart';
import '../../Screen/FullApps/Vpn/mobile/Screens/VpnSelectVpnMobile.dart';
import '../../Screen/FullApps/Vpn/mobile/Screens/VpnSubscriptionDetailMobile.dart';
import '../../Screen/FullApps/Vpn/tablet/Screens/VpnSelectVpnTablet.dart';
import '../../Screen/FullApps/Vpn/tablet/Screens/VpnSubscriptionDetailTablet.dart';
...
final Color vpn22 = Color.fromARGB(255, 49, 214, 247);
final Color vpn33 = Color.fromARGB(255, 47, 120, 247);
final Color vpn44 = Color(0xfff7f1ff);
final Color vpn55 = Color(0x33FFA7A7);
final Color vpn66 = Color.fromARGB(255, 187, 202, 250);
final Color vpn77 = Color.fromARGB(255, 119, 119, 119);
...
Gradient vjpgradient = LinearGradient(
  colors: [
    vpn22,
    vpn33,
  ],
...
BoxDecoration vjpgradient_box = BoxDecoration(
  gradient: vjpgradient,
  boxShadow: [
    boxShadow,
  ],
        ...
        child: Row(
            ...
            children: <Widget>[
              ...
              IconButton(
                    ...
                    if (pos != 1) {
                      if (ismain)
                        Navigator.push(
                            bcontext,
                            MaterialPageRoute(
                                builder: (context) => VpnSelectVpnDesktop()));
                      else
                  ...
                  icon: SvgPicture.network(pos == 1
                      ? 'https://smartkit.wrteam.in/smartkit/vpn/selected_location.svg'
                      : 'https://smartkit.wrteam.in/smartkit/vpn/unsel_location.svg')),
              IconButton(
                  onPressed: () {
                    if (pos != 3) {
                      if (ismain)
                  ...
                  icon: SvgPicture.network(pos == 3
                      ? 'https://smartkit.wrteam.in/smartkit/vpn/sel_premium.svg'
                      : 'https://smartkit.wrteam.in/smartkit/vpn/unsel_premium.svg')),
            ]),
      ),
      mobile: Container(
        decoration: vpntopradiusbox,
                    ...
                    if (pos != 1) {
                      if (ismain)
                        Navigator.push(
                            bcontext,
                            MaterialPageRoute(
                                builder: (context) => VpnSelectVpnMobile()));
                      else
                        Navigator.pushReplacement(
                            bcontext,
                            MaterialPageRoute(
                    ...
                    if (pos != 1) {
                      if (ismain)
                        Navigator.push(
                            bcontext,
                            MaterialPageRoute(
                                builder: (context) => VpnSelectVpnTablet()));
                      else
                        Navigator.pushReplacement(
                            bcontext,
                            MaterialPageRoute(
...
Widget vpnSetAppbar(String bartitle) {
  return new AppBar(
      ...
      elevation: 0.0,
      flexibleSpace:
          Container(width: double.infinity, decoration: vjpgradient_box),
      centerTitle: true,
