...
class _LoginCurveAnimationState extends State<LoginCurveAnimation>
    ...
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          ...
          ScreenTypeLayout(
              mobile: Container(child: _showForm()),
              desktop: Container(
            ...
            child: Card(
                ...
                child: Container(
                  ...
                  child: Card(
                    ...
                    child: Image.network(
                      'https://images2.imgbox.com/d8/02/46th6w19_o.png',
                      height: 40.0,
                      fit: BoxFit.fill,
                    ),
                  ),
            ...
            child: Card(
                ...
                child: Container(
                  ...
                  child: Card(
                    ...
                    child: Image.network(
                      'https://images2.imgbox.com/98/6f/Yl4kkZiJ_o.png',
                      height: 40.0,
                      fit: BoxFit.fill,
                    ),
                  ),
