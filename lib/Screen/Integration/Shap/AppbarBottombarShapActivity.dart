...
class AppbarBottombarShapActivityState
    extends State<AppbarBottombarShapActivity> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        elevation: 0.0,
        title: Text('AppBar And Bottom Shape',
          ...
          children: [
            ...
            Column(
              children: [
                ...
                SizedBox(height: 20),
                Center(
                    child: Text("Chat Shape",
                        style: TextStyle(color: Colors.black, fontSize: 20))),
                SizedBox(height: 20),
                ClipPath(
                    clipper: OvalRightShape(),
                    child: Container(
                      height: 100,
                      color: Color(0xff58508d),
                      child: Column(
                        children: [
                          SizedBox(height: 10),
                          Row(
                ...
                SizedBox(height: 20),
                ClipPath(
                    clipper: OvalBottomShape(),
                    child: Container(
                      height: 100,
                      color: Color(0xffffa600),
                      child: Center(
                          child: Text("Biggest Kit",
                              style: TextStyle(
...
class AppbarShape extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Offset circleCenter =
        Offset(size.width / 2, size.height - centerRoundResial);
    ...
    Offset leftCurveControlPoint =
        Offset(circleCenter.dx * 0.5, size.height - centerRoundResial * 1.5);
    Offset rightCurveControlPoint =
        Offset(circleCenter.dx * 1.6, size.height - centerRoundResial);

    final arcStartAngle = 200 / 180 * pi;
    final avatarLeftPointX =
        circleCenter.dx + centerRoundResial * cos(arcStartAngle);
    final avatarLeftPointY =
        circleCenter.dy + centerRoundResial * sin(arcStartAngle);
    ...
    final avatarRightPointX =
        circleCenter.dx + centerRoundResial * cos(arcEndAngle);
    final avatarRightPointY =
        circleCenter.dy + centerRoundResial * sin(arcEndAngle);
