...
class _FirebaseRealtimeDbState extends State<FirebaseRealtimeDb> {
          ...
          onPressed: () {
            if (nameController.text.trim().isEmpty ||
              ...
              databaseReference
                  .child("items")
                  .push()
                  .set({'itemname': name, 'itemprice': price}).then((value) {
      ...
      children: [
        new Flexible(
          child: new FirebaseAnimatedList(
              query: databaseReference.ref.child('items'),
  ...
  Future<void> editDialog(TextEditingController nameController,
      TextEditingController priceController, String? itemid) async {
    return showDialog(
        context: context,
        builder: (context) {
          return AlertDialog(
