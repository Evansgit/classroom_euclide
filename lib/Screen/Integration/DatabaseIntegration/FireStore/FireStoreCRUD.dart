...
class _FireStoreCRUDState extends State<FireStoreCRUD> {
    ...
    return DefaultTabController(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            title: Text('FireStore', style: TextStyle(color: Colors.black)),
          ...
          Expanded(
            child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  Item item = Item.fromFireStore(querySnapshot.docs[index],
                    ...
                    if (type != 0)
                      Expanded(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () async {
                            if (type == 1) {
                              editDialog(nameController, priceController,
  ...
  Future<void> editDialog(TextEditingController nameController,
      TextEditingController priceController, DocumentReference docref) async {
    return showDialog(
        context: context,
        builder: (context) {
          return AlertDialog(
