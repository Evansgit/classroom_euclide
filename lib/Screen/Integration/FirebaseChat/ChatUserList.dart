...
class ChatUserListState extends State<ChatUserList> {
    ...
    if (choice.title == removeusertitle) {
      ...
      FirebaseFirestore.instance
        ...
        for (DocumentSnapshot doc in value.docs) {
          ...
          String? otheruserId = (doc.data() as Map)['id'];
          String groupChatId;
          ...
          FirebaseFirestore.instance
              .collection('chatmessages/$groupChatId/$groupChatId')
              .get()
              .then((doc) {
  ...
  Widget buildItem(BuildContext context, DocumentSnapshot document) {
    if ((document.data() as Map)['id'] == currentUserId) {
      return Container();
    } else {
          ...
          Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) => MainChatPage(
                      ...
                      username: (document.data() as Map)['name'])));
        },
      );
    }
  }
