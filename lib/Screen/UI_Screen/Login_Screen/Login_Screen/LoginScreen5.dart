...
class LoginScreen5 extends StatefulWidget {
  LoginScreen5({Key? key, this.title}) : super(key: key);
      ...
      child: Column(
        ...
        children: <Widget>[
          Text(
            title,
            style: TextStyle(
                fontWeight: FontWeight.bold, fontSize: 15, fontFamily: "Sofia"),
          ),
          SizedBox(
            height: 10,
          ),
    ...
    return RichText(
      ...
      text: TextSpan(
          ...
          children: [
            TextSpan(
              text: 'bic',
              style: TextStyle(color: Color(0xff2872ba), fontSize: 30),
            ),
            TextSpan(
              text: 'le',
              style: TextStyle(color: Color(0xFF77A1D3), fontSize: 30),
            ),
          ]),
    );
  }
