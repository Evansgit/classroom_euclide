import 'package:crypto_template/Screen/FullApps/RecipesMeat/Screen/Home/home.dart';
import 'package:flutter/material.dart';

class loginExpensa extends StatefulWidget {
  @override
  _loginExpensaState createState() => _loginExpensaState();
}

class _loginExpensaState extends State<loginExpensa> {
  @override
          ...
          child: Container(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: <Widget>[
                  /// Animation text marketplace to choose loginExpensa with Hero Animation (Click to open code)
                  Padding(
                    padding:
