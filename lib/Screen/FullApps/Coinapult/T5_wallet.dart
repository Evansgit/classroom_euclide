        ...
        child: Column(
          children: <Widget>[
            Padding(
              ...
              child: Image.asset(
                "lib/Screen/FullApps/Coinapult/assets/creditCard.jpg",
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            borderRadius: BorderRadius.all(Radius.circular(10.0)),
            gradient:
                LinearGradient(colors: [Color(0xFF20BFF6), Color(0xFF1F9BE9)]),
            boxShadow: [
              BoxShadow(
                  offset: Offset(6, 7),
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        "Send your friends invitations and win",
                        style: TextStyle(
                            color: Colors.white,
                            fontWeight: FontWeight.w400,
                            fontSize: 12.0),
