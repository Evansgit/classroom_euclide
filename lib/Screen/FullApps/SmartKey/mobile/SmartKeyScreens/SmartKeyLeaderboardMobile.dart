...
class SmartKeyLeaderboardMobile extends StatefulWidget {
  ...
  @override
  _SmartKeyLeaderboardMobileState createState() =>
      _SmartKeyLeaderboardMobileState();
}

class _SmartKeyLeaderboardMobileState extends State<SmartKeyLeaderboardMobile>
  ...
  List leaderList = [
    {'rank': "1", 'name': "Jeff Developer", 'score': "1000"},
  ...
  Widget rankLayout() {
    return Stack(
      children: <Widget>[
                                ...
                                child: CircleAvatar(
                                  ...
                                  child: CircleAvatar(
                                    ...
                                    backgroundImage: CachedNetworkImageProvider(
                                        "https://smartkit.wrteam.in/smartkit/images/rank1.png"),
                                  ),
                                )),
                            Padding(
                                            ...
                                            child: CircleAvatar(
                                              ...
                                              backgroundImage:
                                                  CachedNetworkImageProvider(
                                                      "https://smartkit.wrteam.in/smartkit/images/rank2.png"),
                                            ))),
                                    Padding(
                                  ...
                                  CircleAvatar(
                                    ...
                                    child: CircleAvatar(
                                      ...
                                      child: CircleAvatar(
                                        ...
                                        backgroundImage: CachedNetworkImageProvider(
                                            "https://smartkit.wrteam.in/smartkit/images/rank3.png"),
                                      ),
                                    ),
                                  ),
                                  Padding(
        ...
        Container(
            margin: EdgeInsets.only(
                top: 15, left: (MediaQuery.of(context).size.width) / 2 + 35),
            child: CachedNetworkImage(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.only(left: 8.0),
                                    child: Text(leaderList[index]['score'],
                                        style: TextStyle(color: Colors.black)),
                                  )
                                ],
                              ),
