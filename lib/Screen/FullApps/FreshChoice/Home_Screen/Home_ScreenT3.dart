import 'package:crypto_template/Screen/FullApps/FreshChoice/Component_Home_Screen/Home_Clipper.dart';
import 'package:crypto_template/Screen/FullApps/FreshChoice/Model/ModelFashFood.dart';
import 'package:crypto_template/Screen/FullApps/FreshChoice/Model/ModelHealtyFood.dart';
                          ...
                          children: <Widget>[
                            Container(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  Hero(
                                    tag: "image${foodFashList[index].id}",
                                    child: Center(
                                      child: Image(
                                        width: 130,
                                        height: 130,
                                        image: NetworkImage(
                                            foodFashList[index].imgPath!),
                                      ),
                                    ),
                                  ),
                                  SizedBox(
                          ...
                          children: <Widget>[
                            Container(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  Hero(
                                    tag: "image${foodHealtyList[index].id}",
                                    child: Center(
                                      child: Image(
                                        width: 130,
                                        height: 130,
                                        image: NetworkImage(
                                            foodHealtyList[index].imgPath!),
                                      ),
                                    ),
                                  ),
                                  SizedBox(
            ...
            child: Row(
              children: <Widget>[
                Image(
                  width: 80.0,
                  height: 80.0,
                  image: NetworkImage(foodFashList[index].imgPath!),
                ),
                SizedBox(width: 5),
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
            ...
            child: Row(
              children: <Widget>[
                Image(
                  width: 80.0,
                  height: 80.0,
                  image: NetworkImage(foodHealtyList[index].imgPath!),
                ),
                SizedBox(width: 5),
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
