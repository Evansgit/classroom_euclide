                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Column(children: <Widget>[
                      Image.asset(
                        "lib/Screen/FullApps/AlliedWallet/Assets/icon_image.png",
                        height: 45.0,
                      ),
                      Text(
                        "Photo",
                    ...
                    InkWell(
                      ...
                      child: Column(children: <Widget>[
                        Image.asset(
                          "lib/Screen/FullApps/AlliedWallet/Assets/icon_video.png",
                          height: 45.0,
                        ),
                        Text(
                          "Video",
                    ...
                    Column(children: <Widget>[
                      Image.asset(
                        "lib/Screen/FullApps/AlliedWallet/Assets/icon_microphone.png",
                        height: 45.0,
                      ),
                      Text(
                        "Voice",
                    ...
                    Column(children: <Widget>[
                      Image.asset(
                        "lib/Screen/FullApps/AlliedWallet/Assets/icon_file.png",
                        height: 45.0,
                      ),
                      Text(
                        "File",
                    ...
                    Column(children: <Widget>[
                      Image.asset(
                        "lib/Screen/FullApps/AlliedWallet/Assets/icon_monitor.png",
                        height: 45.0,
                      ),
                      Text(
                        "Screen",
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text(
                  "Alex",
                  style: TextStyle(
                      fontFamily: "Sofia", fontSize: 18.0, color: Colors.white),
                ),
              ),
            ],
          ),
          ...
          Padding(
            ...
            child: Center(
              child: Opacity(
                  opacity: 0.5,
                  child: Image.asset(
                    "lib/Screen/FullApps/AlliedWallet/Assets/T1_noMessage.png",
                    height: 150.0,
                  )),
            ),
          ),
