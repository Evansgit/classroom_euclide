...
class _chatItemState extends State<chatItem> with TickerProviderStateMixin {
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Column(children: <Widget>[
                      Image.asset(
                        "lib/Screen/FullApps/VinckierFoods/Assets/image/icon_image.jpg",
                        height: 45.0,
                      ),
                      Text(
                        "Photo",
                        style: TextStyle(fontFamily: "Sofia", fontSize: 11.0),
                      )
                    ]),
                    InkWell(
                      onTap: () {},
                      child: Column(children: <Widget>[
                        Image.asset(
                          "lib/Screen/FullApps/VinckierFoods/Assets/image/icon_video.jpg",
                          height: 45.0,
                        ),
                        Text(
                          "Video",
                    ...
                    Column(children: <Widget>[
                      Image.asset(
                        "lib/Screen/FullApps/VinckierFoods/Assets/image/icon_microphone.jpg",
                        height: 45.0,
                      ),
                      Text(
                        "Voice",
                    ...
                    Column(children: <Widget>[
                      Image.asset(
                        "lib/Screen/FullApps/VinckierFoods/Assets/image/icon_file.jpg",
                        height: 45.0,
                      ),
                      Text(
                        "File",
                    ...
                    Column(children: <Widget>[
                      Image.asset(
                        "lib/Screen/FullApps/VinckierFoods/Assets/image/icon_monitor.jpg",
                        height: 45.0,
                      ),
                      Text(
                        "Screen",
  ...
  Widget _buildComposer() {
    return new IconTheme(
      data: new IconThemeData(color: Colors.black12),
      child: new Container(
          height: 50.0,
                    ...
                    Container(
                      decoration: BoxDecoration(
                          ...
                          gradient: LinearGradient(
                              ...
                              colors: [Color(0xFF5FBD84), Color(0xFF5FBD84)])),
          ...
          Padding(
            ...
            child: Center(
              child: Opacity(
                  opacity: 0.5,
                  child: Image.asset(
                    "lib/Screen/FullApps/VinckierFoods/Assets/image/noMessage.jpg",
                    height: 200.0,
                  )),
            ),
          ),
