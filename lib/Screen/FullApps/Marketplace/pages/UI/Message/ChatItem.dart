...
const String defaultUserName = "Hanson";
          ...
          children: <Widget>[
            Padding(
              ...
              child: Text(
                "Hanson",
                style: TextStyle(
                    fontFamily: "Sofia", fontSize: 18.0, color: Colors.black54),
              ),
            ),
            Text(
              "Last seen today at 14:45",
...
//                backgroundImage: AssetImage("lib/Screen/FullApps/Marketplace/assets/avatars/avatar-1.jpg"),
  ...
  Widget build(BuildContext context) {
    return Center(
      ...
      child: Text(
        "Not Have Message",
        style: TextStyle(
            fontSize: 18.0, color: Colors.black26, fontFamily: "Sofia"),
      ),
    ));
  }
}
