...
import 'package:crypto_template/Screen/FullApps/Vpn/desktop/Screens/VpnHomeDesktop.dart';
...
class VpnSubscriptionDetailDesktop extends StatefulWidget {
  ...
  @override
  _VpnSubscriptionDetailStateDesktop createState() =>
      _VpnSubscriptionDetailStateDesktop();
}

class _VpnSubscriptionDetailStateDesktop
    extends State<VpnSubscriptionDetailDesktop> {
  @override
  Widget build(BuildContext context) {
    final ButtonStyle outlineButtonStyle = TextButton.styleFrom(
      foregroundColor: vpn77.withOpacity(0.5), padding: EdgeInsets.symmetric(
        horizontal: 25,
        vertical: 25,
      ),
