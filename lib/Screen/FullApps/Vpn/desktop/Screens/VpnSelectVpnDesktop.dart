...
class _VpnSelectVpnStateDesktop extends State<VpnSelectVpnDesktop>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: vpnSetAppbar("Select VPN") as PreferredSizeWidget?,
      body: Column(
        children: [
          Container(
            child: TabBar(
...
class VpnServerButton extends StatefulWidget {
  ...
  const VpnServerButton({Key? key, this.active, this.vpnServername, this.flag})
      : super(key: key);
      ...
      child: Container(
        ...
        child: Row(
          children: [
            CachedNetworkImage(
              imageUrl:
                  "https://smartkit.wrteam.in/smartkit/vpn/${widget.flag}",
              height: 30,
              width: 30,
            ),
            RowDivider(),
...
class _SamrtKitHomeTabViewState extends State<SamrtKitHomeTabView> {
  ...
  List vpnServerspremium = [
    ...
    {'flag': "ireland.png", 'vpnServerName': 'ireland', 'status': true},
    {
      ...
      'vpnServerName': 'united-kingdom',
      'status': false
    },
    {
      'flag': "united-states-of-america.png",
      'vpnServerName': 'united-states-of-america',
      'status': true
    },
  ];
  ...
  Widget premiumListWidget() {
    return ListView.builder(
        shrinkWrap: true,
        itemCount:
            vpnServerspremium.length != null ? vpnServerspremium.length : 1,
        itemBuilder: (BuildContext context, int index) {
          return VpnServerButton(
