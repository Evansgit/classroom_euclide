...
class VpnSharePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: vpnSetAppbar("Invite Friends") as PreferredSizeWidget?,
      body: SafeArea(
        child: Column(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              CachedNetworkImage(
                imageUrl:
                    "https://smartkit.wrteam.in/smartkit/vpn/vpnshare.png",
                //height: 200,
              ),
              ColumnDivider(),
              SizedBox(height: 20),
              ...
              ColumnDivider(),
              Text(
                "Help your friend stay anonymous, access Restricted content and enjoy streaming services from all regions with Free VPN APPS.",
