...
import 'package:crypto_template/Screen/FullApps/Vpn/Screens/VpnSubscriptionDetail.dart';
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => VpnSubscriptionDetail()));
              },
              child: Container(
...
//                 }),
  ...
  void _changeLocationClick(bool isfinish) async {
    ...
    await Navigator.push(
        context, MaterialPageRoute(builder: (context) => VpnSelectVpn()));
  }
    ...
    return Column(
      children: [
        ...
        ListTile(
          ...
          onTap: () {
            ...
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => VpnSelectVpn()));
          },
        ),
        ListTile(
          ...
          onTap: () {
            Navigator.of(context).pop();
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => VpnKillSwitch()));
          },
        ),
        Padding(
        ...
        ListTile(
          ...
          leading: CachedNetworkImage(
              imageUrl:
                  "https://smartkit.wrteam.in/smartkit/vpn/dra_share.png"),
          onTap: () {
            Navigator.of(context).pop();
            Navigator.of(context)
                .push(MaterialPageRoute(builder: (context) => VpnSharePage()));
          },
        ),
      ],
    );
